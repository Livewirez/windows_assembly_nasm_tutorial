...
%define w(x) __?utf32?__(x) 
    ...
    uHello dw u('Hello, World (Unicode)'), 0 
    ...
    Pathname  dw u('C:\WINDOWS'), 0     ; Pathname in UTF-16 
    PathnameLength equ ($-Pathname)/2

    String  dd w(`A + B = \u206a`), 0   ; String in UTF-32
    StringLength equ ($-String)/2
